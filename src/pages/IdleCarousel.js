...
const IdleCarousel = () => {
  const idleItems = [
    { title: "Vision", content: "An internationally recognized university that provides relevant and innovative education and resesarch for lifelong learning and sustainable development.", timeToNext: 2000, isVid: false, textSizeClass:"text-lg lg:text-3xl xl:text-4xl text-black" },
    { title: "Mission", content: "Palawan State University is committed to upgrade people's quality of life by providing education opportunities through excellent instruction, research and innovation, extension, production services, and transnational collabortaions", timeToNext: 5000, isVid: false, textSizeClass:"text-lg lg:text-3xl xl:text-4xl text-black" },
    { title: "Core Values", content: "<b>E</b>xcellence in service,<br><b>Q</b>uality assurance,<br><b>U</b>nity in diversity,<br><b>A</b>dvocacy for sustainable development,<br><b>L</b>eadership by example,<br><b>I</b>nnovation,<br><b>T</b>ransparency and<br><b>Y</b>outh empowerment<br><b classname='text-4xl'>(EQUALITY)</b>", timeToNext: 3000, isVid: false, textSizeClass:"text-lg lg:text-3xl xl:text-4xl text-black" },
    { title: "Quality Policy", content: "We Provide equal opportunities for relevant, innovative, and internationally recognized higher education programs and advanced studies for lifelong learning and sustainable development. <br><br>We Strongly commit to deliver excellence in instruction, research, extension, and transnational programs in order to meet the increasing levels of stakeholder demand as well as statutory and regulatory requirements.<br><br> The University shall continually monitor, review and upgrade its quality management system to ensure compliance with national and international standards and requirements.", timeToNext: 3000, isVid: false, textSizeClass:"text-lg lg:text-xl xl:text-2xl text-black" },
  ];
  ...
  return (
    <div className="idle-carousel-container mt-20 w-3/4 p-2 mx-auto">
